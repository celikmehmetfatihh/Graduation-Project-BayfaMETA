            ...
            modelBuilder.Entity("NLayer.Core.Models.VideoInterview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PositionId = 1,
                            UserId = 1,
                            date = new DateTime(2023, 5, 10, 20, 3, 47, 2, DateTimeKind.Local).AddTicks(1559),
                            format = "mp4",
                            size = 12
                        },
                        new
                        {
                            ...
                            PositionId = 1,
                            UserId = 2,
                            date = new DateTime(2023, 5, 10, 20, 3, 47, 2, DateTimeKind.Local).AddTicks(1596),
                            format = "mp3",
                            size = 14
                        },
                        new
                        {
                            ...
                            PositionId = 2,
                            UserId = 3,
                            date = new DateTime(2023, 5, 10, 20, 3, 47, 2, DateTimeKind.Local).AddTicks(1598),
                            format = "mp3",
                            size = 17
                        },
                        new
                        {
                            ...
                            PositionId = 2,
                            UserId = 4,
                            date = new DateTime(2023, 5, 10, 20, 3, 47, 2, DateTimeKind.Local).AddTicks(1600),
                            format = "mp4",
                            size = 21
                        });
                });
