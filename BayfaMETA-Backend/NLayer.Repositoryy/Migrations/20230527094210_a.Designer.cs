            ...
            modelBuilder.Entity("NLayer.Core.Models.VideoInterview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PositionId = 1,
                            UserId = 1,
                            date = new DateTime(2023, 5, 27, 12, 42, 9, 928, DateTimeKind.Local).AddTicks(7433),
                            format = "mp4",
                            size = 12
                        },
                        new
                        {
                            ...
                            PositionId = 1,
                            UserId = 2,
                            date = new DateTime(2023, 5, 27, 12, 42, 9, 928, DateTimeKind.Local).AddTicks(7473),
                            format = "mp3",
                            size = 14
                        },
                        new
                        {
                            ...
                            PositionId = 2,
                            UserId = 3,
                            date = new DateTime(2023, 5, 27, 12, 42, 9, 928, DateTimeKind.Local).AddTicks(7475),
                            format = "mp3",
                            size = 17
                        },
                        new
                        {
                            ...
                            PositionId = 2,
                            UserId = 4,
                            date = new DateTime(2023, 5, 27, 12, 42, 9, 928, DateTimeKind.Local).AddTicks(7477),
                            format = "mp4",
                            size = 21
                        });
                });
