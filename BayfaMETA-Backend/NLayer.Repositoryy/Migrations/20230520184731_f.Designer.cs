            ...
            modelBuilder.Entity("NLayer.Core.Models.VideoInterview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PositionId = 1,
                            UserId = 1,
                            date = new DateTime(2023, 5, 20, 21, 47, 31, 531, DateTimeKind.Local).AddTicks(4306),
                            format = "mp4",
                            size = 12
                        },
                        new
                        {
                            ...
                            PositionId = 1,
                            UserId = 2,
                            date = new DateTime(2023, 5, 20, 21, 47, 31, 531, DateTimeKind.Local).AddTicks(4359),
                            format = "mp3",
                            size = 14
                        },
                        new
                        {
                            ...
                            PositionId = 2,
                            UserId = 3,
                            date = new DateTime(2023, 5, 20, 21, 47, 31, 531, DateTimeKind.Local).AddTicks(4361),
                            format = "mp3",
                            size = 17
                        },
                        new
                        {
                            ...
                            PositionId = 2,
                            UserId = 4,
                            date = new DateTime(2023, 5, 20, 21, 47, 31, 531, DateTimeKind.Local).AddTicks(4363),
                            format = "mp4",
                            size = 21
                        });
                });
