...
namespace NLayer.Repository.Migrations
{
    ...
    [Migration("20230509163521_scoring")]
            ...
            modelBuilder.Entity("NLayer.Core.Models.VideoInterview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PositionId = 1,
                            UserId = 1,
                            date = new DateTime(2023, 5, 9, 19, 35, 21, 331, DateTimeKind.Local).AddTicks(4995),
                            format = "mp4",
                            size = 12
                        },
                        new
                        {
                            ...
                            PositionId = 1,
                            UserId = 2,
                            date = new DateTime(2023, 5, 9, 19, 35, 21, 331, DateTimeKind.Local).AddTicks(5032),
                            format = "mp3",
                            size = 14
                        },
                        new
                        {
                            ...
                            PositionId = 2,
                            UserId = 3,
                            date = new DateTime(2023, 5, 9, 19, 35, 21, 331, DateTimeKind.Local).AddTicks(5035),
                            format = "mp3",
                            size = 17
                        },
                        new
                        {
                            ...
                            PositionId = 2,
                            UserId = 4,
                            date = new DateTime(2023, 5, 9, 19, 35, 21, 331, DateTimeKind.Local).AddTicks(5036),
                            format = "mp4",
                            size = 21
                        });
                });
